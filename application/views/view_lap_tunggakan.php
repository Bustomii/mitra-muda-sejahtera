...
$(function() {
	...
	$("#cetak").click(function(){
		...
		if(jml_pilih.length == 0){
		 ...
		 if(pilih=='tanggal'){
			window.open("<?php echo base_url();?>index.php/laporan/cetak_tunggakan/"+pilih+"/"+tgl);	
		 }else{
			 window.open("<?php echo base_url();?>index.php/laporan/cetak_tunggakan/"+pilih+"/"+kode);	
		 }
	});	
});
</script>
...
<div class="atas">
	...
	Laporan Tunggakan/Piutang Anggota
    </p>
</div>
<div class="tengah">
    <table width="100%">
