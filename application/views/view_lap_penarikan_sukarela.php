...
$(function() {
	...
	$("#cetak").click(function(){
		...
		if(jml_pilih.length == 0){
		 ...
		 if(pilih=='tanggal'){
			window.open("<?php echo base_url();?>index.php/laporan/cetak_penarikan_sukarela/"+pilih+"/"+tgl);	
		 }else{
			 window.open("<?php echo base_url();?>index.php/laporan/cetak_penarikan_sukarela/"+pilih+"/"+kode);	
		 }
	});	
});
</script>
...
<div class="atas">
	...
	Laporan Penarikan Dana Anggota
    </p>
</div>
<div class="tengah">
    <table width="100%">
