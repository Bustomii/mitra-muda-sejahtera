<script type="text/javascript">
	...
	function deleteData(ID) {
		...
		if (pilih == true) {
			$.ajax({
				type: "POST",
				url: "<?php echo site_url(); ?>/simpanan/hapus",
				data: "id=" + id,
...
<div class="tengah">
	<div class="tampil_data">
		<table id="theTable" class="detail" width="100%">
			...
			<?php
			if ($dt_view_simpanan->num_rows() > 0) {
				$no = 1 + $hal;
			...
			?>
					<tr>
						...
						<td align="center">
							<a href="javascript:deleteData('<?php echo $db['id_simpanan'] ?>')">
								<img src="<?php echo base_url(); ?>asset/images/del.png" title='Hapus'>
							</a>
						</td>
						<td align="center">
							<a href="javascript:cetakData('<?php echo $db['id_simpanan'] ?>')">
