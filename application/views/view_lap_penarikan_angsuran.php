...
$(function() {
	...
	$("#cetak").click(function(){
		...
		if(jml_pilih.length == 0){
		 ...
		 if(pilih=='tanggal'){
			window.open("<?php echo base_url();?>index.php/laporan/cetak_penarikan_angsuran/"+pilih+"/"+tgl);	
		 }else{
			 window.open("<?php echo base_url();?>index.php/laporan/cetak_penarikan_angsuran/"+pilih+"/"+kode);	
		 }
	});	
});
</script>
